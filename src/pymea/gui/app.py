...
import importlib
import datetime
from pymea.analysis import batch as batch_analysis
from pymea.analysis import beat_amplitude as calculate_beat_amp_int
from pymea.analysis import beat_detection as determine_beats
from pymea.analysis import conduction_velocity as calculate_cv
from pymea.analysis import field_potential_duration as calculate_fpd
from pymea.analysis import local_activation_time as calculate_lat
from pymea.analysis import pacemaker as calculate_pacemaker
from pymea.analysis import translocation as detect_transloc
from pymea.analysis import upstroke_velocity as calculate_upstroke_vel
from pymea.core import (
    BatchData,
    BeatAmpIntData,
    BeatAmplitudes,
    CondVelData,
    ElectrodeConfig,
    FieldPotDurationData,
    ImportedData,
    InputParameters,
    LocalATData,
    MEAHeatMaps,
...
from pymea.export import collect_output_tables, export_tables_excel
from pymea.exploratory import pca as pca_plotting
from pymea.io import load_mea_recording
from pymea.plotting import main_heatmap
from pymea.plotting import psd as psd_plotting
from pymea.stats import powerlaw as powerlaw_analysis
from pymea.stats import property_vs_distance as property_vs_distance_stats
...
def data_import(analysisGUI, raw_data, electrode_config):
    try:
        ...
        raw_data.imported = load_mea_recording(data_filename_and_path[0])
...
conduction_vel, beat_amp_int, cm_beats, cm_stats, field_potential):
    try:
        ...
        tables = collect_output_tables(type("Run", (), {
            "pace_maker": pace_maker,
            "local_act_time": local_act_time,
            "upstroke_vel": upstroke_vel,
            "conduction_vel": conduction_vel,
            "beat_amp_int": beat_amp_int,
            "field_potential": field_potential,
        })())
        if hasattr(cm_stats, "pace_maker_filtered_data"):
            tables["pm_stats"] = cm_stats.pace_maker_filtered_data
        if hasattr(cm_stats, "local_act_time_filtered_data"):
            tables["lat_stats"] = cm_stats.local_act_time_filtered_data
        if hasattr(cm_stats, "upstroke_vel_filtered_data"):
            tables["upstroke_velocity_stats"] = cm_stats.upstroke_vel_filtered_data
        if hasattr(cm_stats, "conduction_vel_filtered_data"):
            tables["cv_stats"] = cm_stats.conduction_vel_filtered_data

        export_tables_excel(tables, os.path.join(file_path, f"{file_name}.xlsx"))
